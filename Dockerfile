...
ADD https://s3-eu-west-1.amazonaws.com/testing.packages.blackfire.io/blackfire/2.0.0-beta2p5-internal/blackfire-linux_$TARGETARCH /usr/local/bin/blackfire
